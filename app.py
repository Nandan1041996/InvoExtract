...
#     if not invoice_name:
#         return jsonify({"error": "Invoice name not found"}), 400

#     # Read column definitions from JSON file
#     with open('invoice.json', mode='r') as f:
#         result_dict = json.load(f)
#         column_lst = result_dict.get(invoice_name, [])
...
#                                 data_dict['Vendor'] = i.split(':', 1)[-1].strip()
#                             if i.startswith('GSTIN No'):
#                                 data_dict['Vendor GSTIN No'] = i.split(':', 1)[-1].strip()
#                             if i.startswith('PAN No'):
#                                 data_dict['Vendor PAN No'] = i.split(':', 1)[-1].strip()
#                     if data_lst[0].startswith('Detail of Buyer'):
#                         for i in data_lst:
#                             if i.startswith('Name'):
#                                 data_dict['Buyer'] = i.split(':', 1)[-1].strip()
#                             if i.startswith('GSTIN No'):
#                                 data_dict["Buyer's GSTIN No"] = i.split(':', 1)[-1].strip()
#                             if i.startswith('PAN No'):
#                                 data_dict['Vendor PAN No'] = i.split(':', 1)[-1].strip()
#                     if data_lst[0].startswith('Invoice No'):
#                         for i in data_lst:
#                             if i.startswith('Invoice No'):
#                                 data_dict['Invoice No'] = i.split(':', 1)[-1].strip()
#                             if i.startswith('Customer Order No'):
#                                 data_dict['Customer Order No'] = i.split(':', 1)[-1].strip()
#                             if i.startswith('Invoice Date'):
#                                 data_dict['Invoice Date'] = i.split(':', 1)[-1].strip()
